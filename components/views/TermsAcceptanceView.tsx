  ...
  return (
    <div className="vylos-bg-premium fixed inset-0 z-[100] flex flex-col items-center justify-center p-4 md:p-8 overflow-hidden font-inter">
      ...
      <div className="w-full max-w-5xl h-full max-h-[900px] vylos-modal-glass rounded-[3rem] shadow-[0_40px_100px_rgba(0,0,0,0.4)] overflow-hidden flex flex-col animate-in fade-in zoom-in duration-700 relative border border-white/20">
        ...
        {/* Header */}
        <div className="p-8 md:p-10 border-b border-white/10 bg-white/5 backdrop-blur-xl shrink-0 flex items-center justify-between relative z-10">
          <div className="flex items-center gap-5">
            ...
            <div>
              <h2 className="text-3xl font-black text-white tracking-tighter">Legal Requirement</h2>
              <p className="text-[13px] font-medium text-white/50 mt-1">Please review and accept our terms to continue</p>
            </div>
          </div>
          <div className="hidden sm:flex items-center gap-3 px-5 py-2.5 bg-blue-500/10 rounded-2xl border border-blue-500/20">
            ...
            <span className="text-[11px] font-black text-blue-400 uppercase tracking-[0.2em]">Mandatory Step</span>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 md:p-16 custom-scrollbar relative z-10">
          <div className="max-w-3xl mx-auto space-y-12">
            ...
            <div className="p-8 bg-blue-500/5 border border-blue-500/10 rounded-[2.5rem] backdrop-blur-md relative overflow-hidden group">
              ...
              <p className="text-base md:text-lg font-medium text-white/80 leading-relaxed relative z-10">
            ...
            {/* Main Terms Content */}
            <div className="vylos-glass rounded-[3rem] p-10 border border-white/10 shadow-2xl relative">
                <div className="flex items-center gap-4 mb-8">
                    <div className="w-1.5 h-8 bg-blue-500 rounded-full" />
                    <h4 className="text-2xl font-black text-white tracking-tight uppercase">Vylos Terms and Conditions</h4>
                </div>
        ...
        {/* Footer Actions */}
        <div className="p-8 md:p-12 border-t border-white/10 bg-white/5 backdrop-blur-2xl shrink-0 flex flex-col sm:flex-row items-center justify-between gap-8 relative z-10">
          <div className="flex items-center gap-5">
             <div className="w-14 h-14 rounded-full border border-white/10 flex items-center justify-center text-white/40 bg-white/5 shadow-inner">
                <FileText size={24} />
             </div>
             <div className="flex flex-col">
                <p className="text-[11px] font-black text-white/60 uppercase tracking-widest leading-tight mb-1">Confirmation</p>
                <p className="text-[10px] font-medium text-white/30 max-w-[240px] leading-relaxed">

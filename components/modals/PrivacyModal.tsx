        ...
        <div className="relative vylos-modal-glass border border-border-main w-full max-w-3xl h-[85vh] rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 slide-in-from-bottom-10 duration-500 flex flex-col">
          ...
          <div className="p-8 border-b border-border-main shrink-0 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-2xl font-black text-text-main tracking-tight">Privacy Policy</h2>
                <p className="text-xs font-medium text-text-muted">Please review how we handle your data</p>
              </div>
            </div>
            <button 
              onClick={onClose}
              className="p-3 text-text-muted hover:text-text-main hover:bg-border-main/50 rounded-2xl transition-all cursor-pointer"
          ...
          <div className="p-6 border-t border-border-main bg-bg-mint/30 shrink-0 flex justify-center">
            <button 
              onClick={onClose}
              className="px-10 py-4 bg-primary text-white font-black rounded-2xl shadow-xl shadow-primary/20 hover:bg-emerald-400 transition-all active:scale-[0.98] uppercase tracking-widest text-xs cursor-pointer"
            >
              I Understand
            </button>
          </div>

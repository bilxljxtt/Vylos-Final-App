  ...
  return (
    <Portal>
      <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 md:p-6 animate-in fade-in duration-300">
        ...
        <div className="relative vylos-modal-glass w-full max-w-2xl rounded-[2.5rem] shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-300 flex flex-col max-h-[90vh]">
                ...
                {[
                  ...
                  <div key={i} className="space-y-2">
                    <div className="flex justify-between items-center text-[11px] font-black uppercase tracking-tight">
                      ...
                      <span className={p.color === "blue" ? "text-blue-500" : p.color === "red" ? "text-red-500" : p.color === "emerald" ? "text-emerald-500" : "text-purple-500"}>{p.val}/25</span>
                    </div>
                    <div className="h-1.5 w-full bg-border-main rounded-full overflow-hidden">
                      <div 
                        className={`h-full ${p.color === "blue" ? "bg-blue-500" : p.color === "red" ? "bg-red-500" : p.color === "emerald" ? "bg-emerald-500" : "bg-purple-500"} rounded-full transition-all duration-1000 delay-${i * 100}`} 
          ...
          <div className="p-8 bg-border-main/20 border-t border-border-main shrink-0">
            <button 
              onClick={onClose}

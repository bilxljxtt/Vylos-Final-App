...
import { 
  ...
  ChevronRight, ArrowLeft, Phone, Zap, Shield, BarChart3, Target, Lightbulb, Globe 
} from "lucide-react";
            ...
            <div className="space-y-6">
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 py-2 px-2">
                  ...
                  <span className="text-xs font-semibold text-slate-600 dark:text-slate-400 leading-relaxed">
              ...
              <button 
                type="button" 
                onClick={handleNext}
                className="w-full py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-2xl font-black text-[14px] flex items-center justify-center gap-3 shadow-2xl shadow-blue-600/30 transition-all active:scale-95 uppercase tracking-[0.2em]"
              >
                Continue Setup
              ...
              <div className="relative flex items-center justify-center py-2">
                ...
                <span className="relative px-6 bg-white dark:bg-[#111625]/90 text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">Or signup with</span>
              </div>
              ...
              <button 
                ...
                className="w-full py-4 bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl flex items-center justify-center gap-4 hover:bg-slate-50 dark:hover:bg-white/10 transition-all active:scale-95 shadow-sm"
              >
                ...
                <span className="text-sm font-black text-slate-700 dark:text-white tracking-tight">Google Account</span>
              </button>
            </div>
          ) : (
            ...
            <form onSubmit={handleSignup} className="space-y-6">
                ...
                <div className="grid grid-cols-1 gap-2">
                  {[
                    ...
                    <button
                      ...
                      className={`p-4 rounded-2xl border text-left font-bold text-sm transition-all duration-300
                        ${form.userType === opt.id 
                          ? "bg-blue-600 border-blue-600 text-white shadow-lg shadow-blue-600/20" 
                          : "bg-slate-50 dark:bg-white/5 border-slate-200 dark:border-white/10 text-slate-800 dark:text-slate-400 hover:border-blue-600/30"
                        }
                      `}
                    >
                      {opt.label}
                ...
                <div className="grid grid-cols-3 gap-2">
                  {[
                    ...
                    <button
                      ...
                      className={`py-4 px-2 rounded-2xl border text-center font-bold text-xs transition-all duration-300
              ...
              <div className="flex gap-4 pt-4">
                <button 
                  type="button" 
                  onClick={() => setStep(1)}
                  className="flex-1 py-4 bg-white/5 border border-slate-200 dark:border-white/10 text-slate-700 dark:text-white rounded-2xl font-black text-[12px] flex items-center justify-center gap-2 hover:bg-white/10 transition-all uppercase tracking-[0.2em]"
                >
                  <ArrowLeft size={16} />
                  Back
                </button>
                ...
                <button 
                  type="submit" 
                  disabled={loading}
                  className="flex-[2] py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-2xl font-black text-[12px] flex items-center justify-center gap-2 shadow-2xl shadow-blue-600/30 transition-all active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed uppercase tracking-[0.2em]"
                >

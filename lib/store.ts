...
export const CATEGORY_METADATA: Record<TransactionCategory, { icon: string; color: string }> = {
  "Salary": { icon: "Salary", color: "#00BFA5" },
  "Business Income": { icon: "Business Income", color: "#00BFA5" },
  "Refund": { icon: "Refund", color: "#00BFA5" },
  "Other Income": { icon: "Other Income", color: "#00BFA5" },
  "Groceries": { icon: "Groceries", color: "#00C853" },
  "Eating Out": { icon: "Eating Out", color: "#FF7043" },
  "Transport": { icon: "Transport", color: "#7C4DFF" },
  "Bills": { icon: "Bills", color: "#FF6D00" },
  "Rent / Housing": { icon: "Rent / Housing", color: "#795548" },
  "Shopping": { icon: "Shopping", color: "#0091EA" },
  "Health": { icon: "Health", color: "#FF1744" },
  "Education": { icon: "Education", color: "#3F51B5" },
  "Entertainment": { icon: "Entertainment", color: "#F50057" },
  "Subscriptions": { icon: "Subscriptions", color: "#00BCD4" },
  "Debt Payments": { icon: "Debt Payments", color: "#FF1744" },
  "Savings": { icon: "Savings", color: "#00BFA5" },
  "Other": { icon: "Other", color: "#546E7A" },
};
